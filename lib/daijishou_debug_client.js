...
DaijishouDebugClient.prototype.writeFileToTcpSocketFromFile = function(localFilePath, remoteRelativePath) {
...
DaijishouDebugClient.prototype.readFileFromTcpSocketToFile = function(localFilePath) {
    const microOperation = {
...
DaijishouDebugClient.prototype.FILES_SUB_OPERATION_NO_SUCH_FILE_RESULT_STATUS_BYTE_CODE = 0x01;
DaijishouDebugClient.prototype.FILES_SUB_OPERATION_ACCESS_DENIED_RESULT_STATUS_BYTE_CODE = 0x02;
...
DaijishouDebugClient.prototype.pushFile = function(localPath, RemoteUriString, callback) {
    this.ensureConnection((err) => {
        ...
        this.addTaskToExecutionQueue((err, finish) => {
            ...
            this.buildFileDeleteFileSubOperation(localPath, RemoteUriString).run((err, result) => {
                if(callback) callback(err, result);
                finish();
            });
        });
